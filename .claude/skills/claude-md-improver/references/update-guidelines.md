...
### 1. Rules/User Preferences

```markdown
## Rules

- For ambiguous user requests or under-specified requirements, ask for clarification
- Never ask more than one question per response
- When tradeoffs matter: give 3-4 options max with pros/cons and recommend one
```

### 2. Commands/Workflows Discovered
...
### 5. Testing Approaches That Worked
