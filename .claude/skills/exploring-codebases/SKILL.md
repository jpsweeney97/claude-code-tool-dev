...
description: >
  Use when asked to "explore this codebase thoroughly", "understand this codebase",
  or when needing comprehensive architectural understanding of an unfamiliar codebase
  before contributing.
---
...
- Already familiar with the codebase → waste of effort
- Time-constrained → thoroughness requires multiple passes
...
- Pre-mortem: "This exploration would be worthless if ___"
...
- Have someone unfamiliar with the codebase read the report — can they orient?
