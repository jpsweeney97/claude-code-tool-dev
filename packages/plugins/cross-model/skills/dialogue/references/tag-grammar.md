...
When the `/dialogue` skill assembles gatherer outputs (SKILL.md steps 3a-3h (including 3h-bis) map to steps 1-9 below; see SKILL.md Step 3 for the full crosswalk table):
