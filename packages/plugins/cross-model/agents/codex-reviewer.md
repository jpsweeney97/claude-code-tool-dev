...
tools: Bash, Read, Glob, Grep, mcp__plugin_cross-model_codex__codex, mcp__plugin_cross-model_codex__codex-reply
model: opus
---
...
Call `mcp__plugin_cross-model_codex__codex` with:
