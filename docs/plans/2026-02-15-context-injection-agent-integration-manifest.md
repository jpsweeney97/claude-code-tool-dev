...
| D2 | ConversationState works, checkpoint chain validates, compaction preserves invariants, D2 tests pass |
| D4a | 0.2.0 types defined, all 739 existing tests pass with new schema |
| D4b | Pipeline rewired, all tests pass (existing + new), protocol contract updated |
...
**Trigger criteria:**
- Context truncation symptoms during D4b execution
- Subagent missing constraints from earlier in the D4b document
