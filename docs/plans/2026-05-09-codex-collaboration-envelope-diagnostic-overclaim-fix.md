...
**Files:** previously staged via Steps 2.8, 3.7 (conditional), 4.6 (conditional), 5.5 (conditional — state-based, independent of whether Task 3 ran; see Step 5.5 skip condition).
...
1. **Task 3** (JSON disposition): include if Task 3 ran and Step 3.7 staged the JSON.
