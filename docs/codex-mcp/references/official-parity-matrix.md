...
| New MCP config key name parity: `mcp_servers.<id>.startup_timeout_sec` | `../references/codex-mcp-server-beginner-to-expert.md` | `https://developers.openai.com/codex/config-reference` | 2026-02-10 | Verified |
| New MCP config key name parity: `mcp_servers.<id>.tool_timeout_sec` | `../references/codex-mcp-server-beginner-to-expert.md` | `https://developers.openai.com/codex/config-reference` | 2026-02-10 | Verified |
| New MCP config key name parity: `mcp_oauth_credentials_store` | `../references/codex-mcp-server-beginner-to-expert.md` | `https://developers.openai.com/codex/config-reference` | 2026-02-10 | Verified |
